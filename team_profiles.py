...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2411445",  # example: "2024-10123"
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2412863",  # example: "2024-10456
            ...
            photo_url="assets/._dev2.jpg",                 # Photo: local asset or URL (e.g. "https://github.com/dev2-github.png")
        ),
        # ----------------------------------------------------------------------
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2411276",  # example: "2024-10789"
